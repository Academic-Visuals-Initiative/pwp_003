    ...
    if (d.featured && d.featured.length) {
        d.featured.forEach(function(f) {
            ...
            featuredHtml += '<div class="pub-featured">' +
                ...
                (f.image ? '<img class="pub-featured__inline-image" src="' + f.image + '" alt="' + escapeHTML(f.title) + '" width="768" height="1024" loading="lazy">' : '') +
    ...
    if (d.items && d.items.length) {
        d.items.forEach(function(pub) {
            ...
            items += '<div class="pub-item">' +
                ...
                (pub.image ? '<img class="pub-item__img" src="' + pub.image + '" alt="' + escapeHTML(pub.title) + '" width="1024" height="686" loading="lazy">' : '') +
    ...
    if (d.featured && d.featured.length) {
        d.featured.forEach(function(proj) {
            featuredHtml += '<div class="project-card">' +
                ...
                (proj.image ? '<div class="project-card__image-box"><img class="project-card__image" alt="' + escapeHTML(proj.alt || '') + '" src="' + proj.image + '" width="768" height="1024" loading="lazy"></div>' : '') +
        ...
        d.items.forEach(function(proj) {
            items += '<div class="project-box">' +
                ...
                '<div>' +
                    ...
                    (proj.image ? '<img class="project-box__img" src="' + proj.image + '" alt="' + escapeHTML(proj.title) + '" width="768" height="1024" loading="lazy">' : '') +
...
renderers.blog = function(data) {
    ...
    return '<section class="section" id="' + data.id + '">' +
        ...
        '<h2 class="section__title">' + escapeHTML(d.heading) + '</h2>' +
        (d.tagline ? '<p class="section__tagline">' + escapeHTML(d.tagline) + '</p>' : '') +
        '<div class="blog-container" id="blogPostPreview"></div>' +
